...
(function() {
  var Browser, chai, sinon, sinonchai, _;
    ...
    return describe("Board", function() {
      ...
      return describe("A varying number of coins will be given on each space", function() {
        ...
        it("A player accumulates coins by landing on spaces", function() {
          var User, coinsToGive, coinsToGiveSecond, game, spyOn_giveCoin, user, user2;
          User = require('../User.coffee');
          user = new User();
          user2 = new User();
          game = user.createGame();
  ...
  describe("server", function() {
    beforeEach(function() {});
    it("testing 123", function(done) {
      var browser;
      browser = new Browser();
      return browser.visit("http://www.google.com").then(function() {
        browser.success.should.equal(true);
        return console.log(browser.location.toString());
      }).then(done, done);
    });
